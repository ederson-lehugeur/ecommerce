...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto produto5 = new Produto(null, "Toalha", 20.00);
		...
		Produto produto11 = new Produto(null, "Shampoo", 9.00);
		...
		categoritaRepository.saveAll(Arrays.asList(categoria1, categoria2, categoria3, categoria4,
		...
		Cliente cliente1 = new Cliente(null, "Eddye", "eder.lehugeur@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
