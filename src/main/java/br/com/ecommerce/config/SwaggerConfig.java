...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.ecommerce.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API Ecommerce",
				"Esta API é utilizada no curso de Spring Boot",
				"Versão 1.0",
				"",
				new Contact("Ederson Lehugeur", "https://github.com/ederson-lehugeur/ecommerce", "eder.lehugeur@gmail.com"),
				"",
