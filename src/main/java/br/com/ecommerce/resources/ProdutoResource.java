...
public class ProdutoResource {
	...
	public ResponseEntity<Produto> find(@PathVariable Integer id) {
		...
		Produto categoria = produtoService.find(id);
	...
	public ResponseEntity<Page<ProdutoDTO>> findPage(
		...
		Page<Produto> listaProduto = produtoService.search(nomeDecoded, ids, page, linesPerPage,
				orderBy, direction);
		Page<ProdutoDTO> listaCategoriaDTO = listaProduto.map(produto -> new ProdutoDTO(produto));
